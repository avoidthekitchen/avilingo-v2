...
def test_checked_in_selections_losslessly_migrate_current_assignments():
    ...
    expected = {
        ...
        "gcsp:song:xc680976": (2.0, 5.0),
        "gcsp:call:xc425100": (2.0, 4.0),
